...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "stormtrooper@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "stormtrooper API";

        private String description = "stormtrooper API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "stormtrooper";
